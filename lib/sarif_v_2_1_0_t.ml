...
type artifact_mimetype = string [@@deriving show, eq]
...
(** A stable, unique identifier for this external properties object, in the
    form of a GUID. *)
type external_properties_guid = string [@@deriving show, eq]

(** A stable, unique identifier for the run associated with this external
    properties object, in the form of a GUID. *)
type external_properties_run_guid = string [@@deriving show, eq]
...
type property_bag = (string * Yojson.Safe.t) list [@@deriving show, eq]
...
type hm_str_mms = (string * multiformat_message_string) list [@@deriving show, eq]
...
type reporting_descriptor_deprecated_guids_item = string [@@deriving show, eq]

(** A unique identifier for the reporting descriptor in the form of a GUID. *)
type reporting_descriptor_guid = string [@@deriving show, eq]

(** A guid that uniquely identifies the descriptor. *)
type reporting_descriptor_reference_guid = string [@@deriving show, eq]
...
type result_correlation_guid = string [@@deriving show, eq]

(** A stable, unique identifier for the result in the form of a GUID. *)
type result_guid = string [@@deriving show, eq]
...
type result_provenance_first_detection_run_guid = string [@@deriving show, eq]

(** A GUID-valued string equal to the automationDetails.guid property of the
    run in which the result was most recently detected. *)
type result_provenance_last_detection_run_guid = string [@@deriving show, eq]
...
type suppression_guid = string [@@deriving show, eq]
...
type tool_component_dotted_quad_file_version = string [@@deriving show, eq]

(** A unique identifier for the tool component in the form of a GUID. *)
type tool_component_guid = string [@@deriving show, eq]
...
type tool_component_language = string [@@deriving show, eq]

(** The 'guid' property of the referenced toolComponent. *)
type tool_component_reference_guid = string [@@deriving show, eq]
...
(** The language of the messages emitted into the log file during this run
    ...
    code associated with a country or region). The casing is recommended but
    not required (in order for this data to conform to RFC5646). *)
type run_language = string [@@deriving show, eq]
...
type run_baseline_guid = string [@@deriving show, eq]

(** A stable, unique identifier for this object's containing run object in the
    form of a GUID. *)
type run_automation_details_guid = string [@@deriving show, eq]
...
type run_automation_details_correlation_guid = string [@@deriving show, eq]
...
(** A stable, unique identifier for the external property file in the form of a
    GUID. *)
type external_property_file_reference_guid = string [@@deriving show, eq]
