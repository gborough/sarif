...
val write_artifact_mimetype : Buffer.t -> artifact_mimetype -> unit
...
val read_artifact_mimetype : Yojson.Safe.lexer_state -> Lexing.lexbuf -> artifact_mimetype
...
val write_artifact_roles_item : Buffer.t -> artifact_roles_item -> unit
...
val write_external_properties_guid : Buffer.t -> external_properties_guid -> unit
...
val write_external_properties_run_guid : Buffer.t -> external_properties_run_guid -> unit
...
val write_external_properties_version : Buffer.t -> external_properties_version -> unit
...
val write_hm_str_str : Buffer.t -> hm_str_str -> unit
...
val read_hm_str_str : Yojson.Safe.lexer_state -> Lexing.lexbuf -> hm_str_str
...
val write_notification_level : Buffer.t -> notification_level -> unit
...
val write_property_bag : Buffer.t -> property_bag -> unit
...
val read_property_bag : Yojson.Safe.lexer_state -> Lexing.lexbuf -> property_bag
...
val write_address : Buffer.t -> address -> unit
...
val read_address : Yojson.Safe.lexer_state -> Lexing.lexbuf -> address
...
val write_logical_location : Buffer.t -> logical_location -> unit
...
val read_logical_location : Yojson.Safe.lexer_state -> Lexing.lexbuf -> logical_location
...
val write_artifact_location : Buffer.t -> artifact_location -> unit
...
val read_artifact_location : Yojson.Safe.lexer_state -> Lexing.lexbuf -> artifact_location
...
val write_edge : Buffer.t -> edge -> unit
...
val read_edge : Yojson.Safe.lexer_state -> Lexing.lexbuf -> edge
...
val write_location_relationship : Buffer.t -> location_relationship -> unit
...
val write_multiformat_message_string : Buffer.t -> multiformat_message_string -> unit
...
val write_artifact_content : Buffer.t -> artifact_content -> unit
...
val read_artifact_content : Yojson.Safe.lexer_state -> Lexing.lexbuf -> artifact_content
...
val write_hm_str_mms : Buffer.t -> hm_str_mms -> unit
...
val read_hm_str_mms : Yojson.Safe.lexer_state -> Lexing.lexbuf -> hm_str_mms
...
val write_edge_traversal : Buffer.t -> edge_traversal -> unit
...
val read_edge_traversal : Yojson.Safe.lexer_state -> Lexing.lexbuf -> edge_traversal
...
val write_graph_traversal_variant0 : Buffer.t -> graph_traversal_variant0 -> unit
...
val write_graph_traversal_variant1 : Buffer.t -> graph_traversal_variant1 -> unit
...
val write_graph_traversal : Buffer.t -> graph_traversal -> unit
...
val read_graph_traversal : Yojson.Safe.lexer_state -> Lexing.lexbuf -> graph_traversal
...
val write_rectangle : Buffer.t -> rectangle -> unit
...
val read_rectangle : Yojson.Safe.lexer_state -> Lexing.lexbuf -> rectangle
...
val write_region : Buffer.t -> region -> unit
...
val write_attachment : Buffer.t -> attachment -> unit
...
val read_attachment : Yojson.Safe.lexer_state -> Lexing.lexbuf -> attachment
...
val write_physical_location : Buffer.t -> physical_location -> unit
...
val read_physical_location : Yojson.Safe.lexer_state -> Lexing.lexbuf -> physical_location
...
val read_location : Yojson.Safe.lexer_state -> Lexing.lexbuf -> location
...
val write_replacement : Buffer.t -> replacement -> unit
...
val read_replacement : Yojson.Safe.lexer_state -> Lexing.lexbuf -> replacement
...
val write_artifact_change : Buffer.t -> artifact_change -> unit
...
val read_artifact_change : Yojson.Safe.lexer_state -> Lexing.lexbuf -> artifact_change
...
val write_fix : Buffer.t -> fix -> unit
...
val read_fix : Yojson.Safe.lexer_state -> Lexing.lexbuf -> fix
...
val write_reporting_configuration : Buffer.t -> reporting_configuration -> unit
...
val write_reporting_descriptor_guid : Buffer.t -> reporting_descriptor_guid -> unit
...
val write_result_baseline_state : Buffer.t -> result_baseline_state -> unit
...
val write_result_correlation_guid : Buffer.t -> result_correlation_guid -> unit
...
val write_result_guid : Buffer.t -> result_guid -> unit
...
val read_result_guid : Yojson.Safe.lexer_state -> Lexing.lexbuf -> result_guid
...
val write_result_kind : Buffer.t -> result_kind -> unit
...
val read_result_kind : Yojson.Safe.lexer_state -> Lexing.lexbuf -> result_kind
...
val write_result_level : Buffer.t -> result_level -> unit
...
val read_result_level : Yojson.Safe.lexer_state -> Lexing.lexbuf -> result_level
...
val write_result_provenance : Buffer.t -> result_provenance -> unit
...
val read_result_provenance : Yojson.Safe.lexer_state -> Lexing.lexbuf -> result_provenance
...
val write_stack_frame : Buffer.t -> stack_frame -> unit
...
val read_stack_frame : Yojson.Safe.lexer_state -> Lexing.lexbuf -> stack_frame
...
val write_stack : Buffer.t -> stack -> unit
...
val read_stack : Yojson.Safe.lexer_state -> Lexing.lexbuf -> stack
...
val write_suppression_guid : Buffer.t -> suppression_guid -> unit
...
val read_suppression_guid : Yojson.Safe.lexer_state -> Lexing.lexbuf -> suppression_guid
...
val write_suppression_kind : Buffer.t -> suppression_kind -> unit
...
val read_suppression_kind : Yojson.Safe.lexer_state -> Lexing.lexbuf -> suppression_kind
...
val write_suppression_status : Buffer.t -> suppression_status -> unit
...
val write_suppression : Buffer.t -> suppression -> unit
...
val read_suppression : Yojson.Safe.lexer_state -> Lexing.lexbuf -> suppression
...
val write_tool_component_contents_item : Buffer.t -> tool_component_contents_item -> unit
...
val write_tool_component_guid : Buffer.t -> tool_component_guid -> unit
...
val write_tool_component_language : Buffer.t -> tool_component_language -> unit
...
val write_tool_component_reference : Buffer.t -> tool_component_reference -> unit
...
val write_configuration_override : Buffer.t -> configuration_override -> unit
...
val write_reporting_descriptor : Buffer.t -> reporting_descriptor -> unit
...
val write_translation_metadata : Buffer.t -> translation_metadata -> unit
...
val write_tool_component : Buffer.t -> tool_component -> unit
...
val read_tool_component : Yojson.Safe.lexer_state -> Lexing.lexbuf -> tool_component
...
val write_tool : Buffer.t -> tool -> unit
...
val read_web_request : Yojson.Safe.lexer_state -> Lexing.lexbuf -> web_request
...
val write_web_response : Buffer.t -> web_response -> unit
...
val read_web_response : Yojson.Safe.lexer_state -> Lexing.lexbuf -> web_response
...
val write_thread_flow_location : Buffer.t -> thread_flow_location -> unit
...
val write_thread_flow : Buffer.t -> thread_flow -> unit
...
val read_thread_flow : Yojson.Safe.lexer_state -> Lexing.lexbuf -> thread_flow
...
val write_code_flow : Buffer.t -> code_flow -> unit
...
val read_code_flow : Yojson.Safe.lexer_state -> Lexing.lexbuf -> code_flow
...
val write_node : Buffer.t -> node -> unit
...
val read_exception_ : Yojson.Safe.lexer_state -> Lexing.lexbuf -> exception_
...
val write_graph : Buffer.t -> graph -> unit
...
val read_notification : Yojson.Safe.lexer_state -> Lexing.lexbuf -> notification
...
val write_invocation : Buffer.t -> invocation -> unit
...
val read_invocation : Yojson.Safe.lexer_state -> Lexing.lexbuf -> invocation
...
val write_conversion : Buffer.t -> conversion -> unit
...
val read_conversion : Yojson.Safe.lexer_state -> Lexing.lexbuf -> conversion
...
val write_artifact : Buffer.t -> artifact -> unit
...
val read_artifact : Yojson.Safe.lexer_state -> Lexing.lexbuf -> artifact
...
val write_external_properties : Buffer.t -> external_properties -> unit
...
val write_version_control_details : Buffer.t -> version_control_details -> unit
...
val write_special_locations : Buffer.t -> special_locations -> unit
...
val write_sarif_version : Buffer.t -> sarif_version -> unit
...
val read_sarif_version : Yojson.Safe.lexer_state -> Lexing.lexbuf -> sarif_version
...
val write_run_language : Buffer.t -> run_language -> unit
...
val read_run_language : Yojson.Safe.lexer_state -> Lexing.lexbuf -> run_language
...
val write_run_column_kind : Buffer.t -> run_column_kind -> unit
...
val read_run_column_kind : Yojson.Safe.lexer_state -> Lexing.lexbuf -> run_column_kind
...
val write_run_baseline_guid : Buffer.t -> run_baseline_guid -> unit
...
val read_run_baseline_guid : Yojson.Safe.lexer_state -> Lexing.lexbuf -> run_baseline_guid
...
val write_run_automation_details_guid : Buffer.t -> run_automation_details_guid -> unit
...
val write_run_automation_details : Buffer.t -> run_automation_details -> unit
...
val write_hm_str_al : Buffer.t -> hm_str_al -> unit
...
val read_hm_str_al : Yojson.Safe.lexer_state -> Lexing.lexbuf -> hm_str_al
...
val write_run : Buffer.t -> run -> unit
...
val read_sarif_json_schema : Yojson.Safe.lexer_state -> Lexing.lexbuf -> sarif_json_schema
