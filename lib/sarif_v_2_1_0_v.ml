...
let validate__float_option _ _ = None
let validate__string_list _ _ = None
let validate__string_list_option _ _ = None
let validate__string_option _ _ = None
let validate__x_c3c9756 _ _ = None

let validate__x_d561347 path x =
  match
    (fun path x ->
      let msg = "Failed check by Sarif_v_2_1_0_util.validate_property_bag" in
      if Sarif_v_2_1_0_util.validate_property_bag x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  with
  | Some _ as err -> err
  | None ->
    (Atdgen_runtime.Ov_run.validate_list (fun path x ->
       let _, x = x in
       (fun _ _ -> None) (`Index 1 :: path) x))
      path
      x
;;

let validate_artifact_mimetype path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_artifact_mimetype" in
  if Sarif_v_2_1_0_util.validate_artifact_mimetype x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__artifact_mimetype_option =
  Atdgen_runtime.Ov_run.validate_option validate_artifact_mimetype
;;

let validate_artifact_roles_item _ _ = None
let validate__artifact_roles_item_list _ _ = None
let validate__artifact_roles_item_list_option _ _ = None

let validate_external_properties_guid path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_external_properties_guid" in
  if Sarif_v_2_1_0_util.validate_external_properties_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__external_properties_guid_option =
  Atdgen_runtime.Ov_run.validate_option validate_external_properties_guid
;;

let validate_external_properties_run_guid path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_external_properties_run_guid" in
  if Sarif_v_2_1_0_util.validate_external_properties_run_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;
...
let validate_external_properties_version _ _ = None
let validate__external_properties_version_option _ _ = None
let validate_hm_str_str = validate__x_c3c9756
let validate__hm_str_str_option _ _ = None
let validate_int64 _ _ = None
let validate__int64_option _ _ = None
let validate_notification_level _ _ = None
let validate__notification_level_option _ _ = None
let validate_property_bag = validate__x_d561347

let validate__property_bag_option =
  Atdgen_runtime.Ov_run.validate_option validate_property_bag
;;
...
let validate_address : _ -> address -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_address x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  with
  | Some _ as err -> err
  | None -> validate__property_bag_option (`Field "properties" :: path) x.properties
;;

let validate__address_list = Atdgen_runtime.Ov_run.validate_list validate_address

let validate__address_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__address_list
;;

let validate__address_option = Atdgen_runtime.Ov_run.validate_option validate_address
...
let validate_logical_location : _ -> logical_location -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_logical_location x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
...
let validate__logical_location_list =
  Atdgen_runtime.Ov_run.validate_list validate_logical_location
;;

let validate__logical_location_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__logical_location_list
;;

let validate_message : _ -> message -> _ =
  fun path x -> validate__property_bag_option (`Field "properties" :: path) x.properties
;;

let validate__message_option = Atdgen_runtime.Ov_run.validate_option validate_message
...
let validate_artifact_location : _ -> artifact_location -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_artifact_location x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__message_option (`Field "description" :: path) x.description with
     | Some _ as err -> err
     | None -> validate__property_bag_option (`Field "properties" :: path) x.properties)
;;

let validate__artifact_location_list =
  Atdgen_runtime.Ov_run.validate_list validate_artifact_location
;;

let validate__artifact_location_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__artifact_location_list
;;

let validate__artifact_location_option =
  Atdgen_runtime.Ov_run.validate_option validate_artifact_location
;;

let validate_edge : _ -> edge -> _ =
  fun path x ->
  match validate__message_option (`Field "label" :: path) x.label with
  | Some _ as err -> err
  | None -> validate__property_bag_option (`Field "properties" :: path) x.properties
;;

let validate__edge_list = Atdgen_runtime.Ov_run.validate_list validate_edge
let validate__edge_list_option = Atdgen_runtime.Ov_run.validate_option validate__edge_list
...
let validate_location_relationship : _ -> location_relationship -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_location_relationship x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
...
let validate__location_relationship_list =
  Atdgen_runtime.Ov_run.validate_list validate_location_relationship
;;

let validate__location_relationship_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__location_relationship_list
;;
...
let validate__x_a05fe6a =
  Atdgen_runtime.Ov_run.validate_list (fun path x ->
    let _, x = x in
    validate_multiformat_message_string (`Index 1 :: path) x)
;;

let validate_artifact_content : _ -> artifact_content -> _ =
  fun path x ->
  match validate__property_bag_option (`Field "properties" :: path) x.properties with
  | Some _ as err -> err
  | None ->
    validate__multiformat_message_string_option (`Field "rendered" :: path) x.rendered
;;

let validate__artifact_content_option =
  Atdgen_runtime.Ov_run.validate_option validate_artifact_content
;;

let validate_hm_str_mms = validate__x_a05fe6a

let validate__hm_str_mms_option =
  Atdgen_runtime.Ov_run.validate_option validate_hm_str_mms
;;
...
let validate_edge_traversal : _ -> edge_traversal -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_edge_traversal x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__hm_str_mms_option (`Field "final_state" :: path) x.final_state with
     | Some _ as err -> err
     | None ->
       (match validate__message_option (`Field "message" :: path) x.message with
        | Some _ as err -> err
        | None -> validate__property_bag_option (`Field "properties" :: path) x.properties))
;;

let validate__edge_traversal_list =
  Atdgen_runtime.Ov_run.validate_list validate_edge_traversal
;;

let validate__edge_traversal_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__edge_traversal_list
;;
...
let validate_graph_traversal_variant0 : _ -> graph_traversal_variant0 -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_graph_traversal_variant0 x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
        ...
        | None ->
          (match
           ...
           | None ->
             (match
                validate__hm_str_mms_option
                  (`Field "initial_state" :: path)
                  x.initial_state
              with
              | Some _ as err -> err
              | None ->
                validate__property_bag_option (`Field "properties" :: path) x.properties))))
;;
...
let validate_graph_traversal_variant1 : _ -> graph_traversal_variant1 -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_graph_traversal_variant1 x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
...
let validate_graph_traversal path x =
  match x with
  | `Variant0 x -> validate_graph_traversal_variant0 path x
  | `Variant1 x -> validate_graph_traversal_variant1 path x
;;

let validate__graph_traversal_list =
  Atdgen_runtime.Ov_run.validate_list validate_graph_traversal
;;

let validate__graph_traversal_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__graph_traversal_list
;;
...
let validate__rectangle_list = Atdgen_runtime.Ov_run.validate_list validate_rectangle

let validate__rectangle_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__rectangle_list
;;
...
let validate_region : _ -> region -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_region x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
    ...
    (match validate__message_option (`Field "message" :: path) x.message with
     ...
     | None ->
       (match
        ...
        with
        | Some _ as err -> err
        | None -> validate__artifact_content_option (`Field "snippet" :: path) x.snippet))
;;

let validate__region_list = Atdgen_runtime.Ov_run.validate_list validate_region

let validate__region_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__region_list
;;

let validate__region_option = Atdgen_runtime.Ov_run.validate_option validate_region
...
let validate_attachment : _ -> attachment -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_attachment x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate_artifact_location (`Field "artifact_location" :: path) x.artifact_location
     with
     | Some _ as err -> err
     | None ->
       (match validate__message_option (`Field "description" :: path) x.description with
        ...
        | None ->
          (match
           ...
           | None ->
             (match
                validate__rectangle_list_option (`Field "rectangles" :: path) x.rectangles
              with
              | Some _ as err -> err
              | None -> validate__region_list_option (`Field "regions" :: path) x.regions))))
;;

let validate__attachment_list = Atdgen_runtime.Ov_run.validate_list validate_attachment

let validate__attachment_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__attachment_list
;;

let validate_physical_location : _ -> physical_location -> _ =
  fun path x ->
  match validate__address_option (`Field "address" :: path) x.address with
  | Some _ as err -> err
  | None ->
    (match
       validate__artifact_location_option
         (`Field "artifact_location" :: path)
         x.artifact_location
     with
     | Some _ as err -> err
     | None ->
       (match
          validate__region_option (`Field "context_region" :: path) x.context_region
        with
        | Some _ as err -> err
        | None ->
          (match
           ...
           with
           | Some _ as err -> err
           | None -> validate__region_option (`Field "region" :: path) x.region)))
;;

let validate__physical_location_list =
  Atdgen_runtime.Ov_run.validate_list validate_physical_location
;;
...
let validate__physical_location_option =
  Atdgen_runtime.Ov_run.validate_option validate_physical_location
;;
...
let validate_location : _ -> location -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_location x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__region_list_option (`Field "annotations" :: path) x.annotations with
     | Some _ as err -> err
     | None ->
       (match
          validate__logical_location_list_option
            (`Field "logical_locations" :: path)
            x.logical_locations
        with
        | Some _ as err -> err
        | None ->
...
let validate__location_list = Atdgen_runtime.Ov_run.validate_list validate_location

let validate__location_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__location_list
;;

let validate__location_option = Atdgen_runtime.Ov_run.validate_option validate_location

let validate_replacement : _ -> replacement -> _ =
  fun path x ->
  match validate_region (`Field "deleted_region" :: path) x.deleted_region with
  | Some _ as err -> err
  | None ->
    (match
       validate__artifact_content_option
         (`Field "inserted_content" :: path)
         x.inserted_content
     with
     | Some _ as err -> err
     | None -> validate__property_bag_option (`Field "properties" :: path) x.properties)
...
let validate__replacement_list = Atdgen_runtime.Ov_run.validate_list validate_replacement
...
let validate_artifact_change : _ -> artifact_change -> _ =
  ...
  | None ->
    (match validate__property_bag_option (`Field "properties" :: path) x.properties with
     | Some _ as err -> err
     | None -> validate__replacement_list (`Field "replacements" :: path) x.replacements)
;;

let validate__artifact_change_list =
  Atdgen_runtime.Ov_run.validate_list validate_artifact_change
;;
...
let validate_fix : _ -> fix -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_fix x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
...
let validate__fix_list = Atdgen_runtime.Ov_run.validate_list validate_fix
let validate__fix_list_option = Atdgen_runtime.Ov_run.validate_option validate__fix_list
let validate_reporting_configuration_level _ _ = None
let validate__reporting_configuration_level_option _ _ = None
...
let validate_reporting_configuration : _ -> reporting_configuration -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_reporting_configuration x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__property_bag_option (`Field "parameters" :: path) x.parameters with
     | Some _ as err -> err
     | None -> validate__property_bag_option (`Field "properties" :: path) x.properties)
;;

let validate__reporting_configuration_option =
  Atdgen_runtime.Ov_run.validate_option validate_reporting_configuration
;;

let validate_reporting_descriptor_deprecated_guids_item path x =
  let msg =
    "Failed check by \
     Sarif_v_2_1_0_util.validate_reporting_descriptor_deprecated_guids_item"
  in
  if Sarif_v_2_1_0_util.validate_reporting_descriptor_deprecated_guids_item x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__list_2041d89 =
  Atdgen_runtime.Ov_run.validate_list validate_reporting_descriptor_deprecated_guids_item
;;

let validate__option_aa202c3 =
  Atdgen_runtime.Ov_run.validate_option validate__list_2041d89
;;

let validate_reporting_descriptor_guid path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_reporting_descriptor_guid" in
  if Sarif_v_2_1_0_util.validate_reporting_descriptor_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__reporting_descriptor_guid_option =
  Atdgen_runtime.Ov_run.validate_option validate_reporting_descriptor_guid
;;

let validate_reporting_descriptor_reference_guid path x =
  let msg =
    "Failed check by Sarif_v_2_1_0_util.validate_reporting_descriptor_reference_guid"
  in
  if Sarif_v_2_1_0_util.validate_reporting_descriptor_reference_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;
...
let validate_result_baseline_state _ _ = None
let validate__result_baseline_state_option _ _ = None

let validate_result_correlation_guid path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_result_correlation_guid" in
  if Sarif_v_2_1_0_util.validate_result_correlation_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__result_correlation_guid_option =
  Atdgen_runtime.Ov_run.validate_option validate_result_correlation_guid
;;

let validate_result_guid path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_result_guid" in
  if Sarif_v_2_1_0_util.validate_result_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__result_guid_option =
  Atdgen_runtime.Ov_run.validate_option validate_result_guid
;;

let validate_result_kind _ _ = None
let validate__result_kind_option _ _ = None
let validate_result_level _ _ = None
let validate__result_level_option _ _ = None

let validate_result_provenance_first_detection_run_guid path x =
  let msg =
    "Failed check by \
     Sarif_v_2_1_0_util.validate_result_provenance_first_detection_run_guid"
  in
  if Sarif_v_2_1_0_util.validate_result_provenance_first_detection_run_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;
...
let validate_result_provenance_last_detection_run_guid path x =
  let msg =
    "Failed check by \
     Sarif_v_2_1_0_util.validate_result_provenance_last_detection_run_guid"
  in
  if Sarif_v_2_1_0_util.validate_result_provenance_last_detection_run_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__option_0fcda76 =
  Atdgen_runtime.Ov_run.validate_option validate_result_provenance_last_detection_run_guid
;;
...
let validate_result_provenance : _ -> result_provenance -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_result_provenance x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__physical_location_list_option
         (`Field "conversion_sources" :: path)
         x.conversion_sources
     with
     | Some _ as err -> err
     | None ->
       (match
          validate__option_60f83e5
            (`Field "first_detection_run_guid" :: path)
            x.first_detection_run_guid
        with
        | Some _ as err -> err
        | None ->
          (match
             validate__option_0fcda76
               (`Field "last_detection_run_guid" :: path)
               x.last_detection_run_guid
           with
           | Some _ as err -> err
           | None ->
             validate__property_bag_option (`Field "properties" :: path) x.properties)))
...
let validate__result_provenance_option =
  Atdgen_runtime.Ov_run.validate_option validate_result_provenance
;;

let validate_stack_frame : _ -> stack_frame -> _ =
  fun path x ->
  match validate__location_option (`Field "location" :: path) x.location with
  | Some _ as err -> err
  | None -> validate__property_bag_option (`Field "properties" :: path) x.properties
;;

let validate__stack_frame_list = Atdgen_runtime.Ov_run.validate_list validate_stack_frame

let validate_stack : _ -> stack -> _ =
  fun path x ->
  match validate__stack_frame_list (`Field "frames" :: path) x.frames with
  | Some _ as err -> err
  | None ->
    (match validate__message_option (`Field "message" :: path) x.message with
     | Some _ as err -> err
...
let validate__stack_list = Atdgen_runtime.Ov_run.validate_list validate_stack

let validate__stack_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__stack_list
;;

let validate__stack_option = Atdgen_runtime.Ov_run.validate_option validate_stack

let validate_suppression_guid path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_suppression_guid" in
  if Sarif_v_2_1_0_util.validate_suppression_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__suppression_guid_option =
  Atdgen_runtime.Ov_run.validate_option validate_suppression_guid
;;

let validate_suppression_kind _ _ = None
let validate_suppression_status _ _ = None
let validate__suppression_status_option _ _ = None
...
let validate_suppression : _ -> suppression -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_suppression x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__suppression_guid_option (`Field "guid" :: path) x.guid with
     | Some _ as err -> err
     | None ->
       (match validate__location_option (`Field "location" :: path) x.location with
        | Some _ as err -> err
...
let validate__suppression_list = Atdgen_runtime.Ov_run.validate_list validate_suppression

let validate__suppression_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__suppression_list
;;

let validate_thread_flow_location_importance _ _ = None
let validate__thread_flow_location_importance_option _ _ = None
let validate_tool_component_contents_item _ _ = None
let validate__tool_component_contents_item_list _ _ = None
let validate__option_0ba29ed _ _ = None

let validate_tool_component_dotted_quad_file_version path x =
  let msg =
    "Failed check by Sarif_v_2_1_0_util.validate_tool_component_dotted_quad_file_version"
  in
  if Sarif_v_2_1_0_util.validate_tool_component_dotted_quad_file_version x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__option_d07cfb1 =
  Atdgen_runtime.Ov_run.validate_option validate_tool_component_dotted_quad_file_version
;;

let validate_tool_component_guid path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_tool_component_guid" in
  if Sarif_v_2_1_0_util.validate_tool_component_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;
...
let validate_tool_component_language path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_tool_component_language" in
  if Sarif_v_2_1_0_util.validate_tool_component_language x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__tool_component_language_option =
  Atdgen_runtime.Ov_run.validate_option validate_tool_component_language
;;

let validate_tool_component_reference_guid path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_tool_component_reference_guid" in
  if Sarif_v_2_1_0_util.validate_tool_component_reference_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__tool_component_reference_guid_option =
  Atdgen_runtime.Ov_run.validate_option validate_tool_component_reference_guid
;;
...
let validate_tool_component_reference : _ -> tool_component_reference -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_tool_component_reference x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__tool_component_reference_guid_option (`Field "guid" :: path) x.guid
     with
     | Some _ as err -> err
     | None -> validate__property_bag_option (`Field "properties" :: path) x.properties)
;;
...
let validate__tool_component_reference_list =
  Atdgen_runtime.Ov_run.validate_list validate_tool_component_reference
;;

let validate__tool_component_reference_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__tool_component_reference_list
;;

let validate__tool_component_reference_option =
  Atdgen_runtime.Ov_run.validate_option validate_tool_component_reference
;;
...
let validate_reporting_descriptor_reference : _ -> reporting_descriptor_reference -> _ =
  ...
  match
    (fun path x ->
      let msg =
        "Failed check by Sarif_v_2_1_0_util.validate_reporting_descriptor_reference"
      in
      if Sarif_v_2_1_0_util.validate_reporting_descriptor_reference x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__reporting_descriptor_reference_guid_option (`Field "guid" :: path) x.guid
     with
     | Some _ as err -> err
     | None ->
       (match
...
let validate__reporting_descriptor_reference_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__reporting_descriptor_reference_list
;;

let validate__reporting_descriptor_reference_option =
  Atdgen_runtime.Ov_run.validate_option validate_reporting_descriptor_reference
;;

let validate_configuration_override : _ -> configuration_override -> _ =
  fun path x ->
  match
    validate_reporting_configuration (`Field "configuration" :: path) x.configuration
  with
  | Some _ as err -> err
  | None ->
    (match
       validate_reporting_descriptor_reference (`Field "descriptor" :: path) x.descriptor
     with
     | Some _ as err -> err
     | None -> validate__property_bag_option (`Field "properties" :: path) x.properties)
;;
...
let validate__configuration_override_list =
  Atdgen_runtime.Ov_run.validate_list validate_configuration_override
;;

let validate__configuration_override_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__configuration_override_list
;;

let validate_reporting_descriptor_relationship
  : _ -> reporting_descriptor_relationship -> _
  =
  fun path x ->
  match
    (fun path x ->
      let msg =
        "Failed check by Sarif_v_2_1_0_util.validate_reporting_descriptor_relationship"
      in
      if Sarif_v_2_1_0_util.validate_reporting_descriptor_relationship x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
    ...
    (match validate__message_option (`Field "description" :: path) x.description with
     ...
     | None ->
       (match
        ...
        | Some _ as err -> err
        | None ->
          validate_reporting_descriptor_reference (`Field "target" :: path) x.target))
;;

let validate__reporting_descriptor_relationship_list =
  Atdgen_runtime.Ov_run.validate_list validate_reporting_descriptor_relationship
;;
...
let validate_reporting_descriptor : _ -> reporting_descriptor -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_reporting_descriptor x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__reporting_configuration_option
         (`Field "default_configuration" :: path)
         x.default_configuration
     with
     | Some _ as err -> err
     | None ->
       (match
          validate__option_aa202c3 (`Field "deprecated_guids" :: path) x.deprecated_guids
        with
        | Some _ as err -> err
        | None ->
          (match
             validate__multiformat_message_string_option
               (`Field "full_description" :: path)
               x.full_description
           with
           | Some _ as err -> err
           | None ->
             (match
                validate__reporting_descriptor_guid_option (`Field "guid" :: path) x.guid
              with
              | Some _ as err -> err
              | None ->
                (match
                      ...
                      (match
                       ...
                       | None ->
                         (match
                          ...
                          | None ->
                            validate__multiformat_message_string_option
                              (`Field "short_description" :: path)
                              x.short_description))))))))
;;

let validate__reporting_descriptor_list =
  Atdgen_runtime.Ov_run.validate_list validate_reporting_descriptor
;;

let validate__reporting_descriptor_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__reporting_descriptor_list
;;
...
let validate_translation_metadata : _ -> translation_metadata -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_translation_metadata x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
...
let validate__translation_metadata_option =
  Atdgen_runtime.Ov_run.validate_option validate_translation_metadata
;;
...
let validate_tool_component : _ -> tool_component -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_tool_component x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__tool_component_reference_option
         (`Field "associated_component" :: path)
         x.associated_component
     with
     | Some _ as err -> err
     | None ->
       (match
          validate__option_d07cfb1
            (`Field "dotted_quad_file_version" :: path)
            x.dotted_quad_file_version
        with
        | Some _ as err -> err
        | None ->
          (match
           ...
           | None ->
             (match
                validate__hm_str_mms_option
                  (`Field "global_message_strings" :: path)
                  x.global_message_strings
              with
              | Some _ as err -> err
              | None ->
                (match
                   validate__tool_component_guid_option (`Field "guid" :: path) x.guid
                 with
                 | Some _ as err -> err
                 | None ->
                   (match
                                   ...
                                   | None ->
                                     (match
                                        validate__tool_component_reference_list_option
                                          (`Field "supported_taxonomies" :: path)
                                          x.supported_taxonomies
                                      with
                                      | Some _ as err -> err
                                      | None ->
                                        (match
                                         ...
                                         | None ->
                                           validate__translation_metadata_option
                                             (`Field "translation_metadata" :: path)
                                             x.translation_metadata)))))))))))))
;;

let validate__tool_component_list =
  Atdgen_runtime.Ov_run.validate_list validate_tool_component
;;

let validate__tool_component_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__tool_component_list
;;

let validate__tool_component_option =
  Atdgen_runtime.Ov_run.validate_option validate_tool_component
;;
...
let validate_tool : _ -> tool -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_tool x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate_tool_component (`Field "driver" :: path) x.driver with
     | Some _ as err -> err
     | None ->
       (match
          validate__tool_component_list_option (`Field "extensions" :: path) x.extensions
        with
        | Some _ as err -> err
        | None -> validate__property_bag_option (`Field "properties" :: path) x.properties))
;;
...
let validate_web_request : _ -> web_request -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_web_request x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__artifact_content_option (`Field "body" :: path) x.body with
     | Some _ as err -> err
     | None -> validate__property_bag_option (`Field "properties" :: path) x.properties)
;;

let validate__web_request_list = Atdgen_runtime.Ov_run.validate_list validate_web_request

let validate__web_request_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__web_request_list
;;

let validate__web_request_option =
  Atdgen_runtime.Ov_run.validate_option validate_web_request
;;
...
let validate_web_response : _ -> web_response -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_web_response x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
...
let validate__web_response_list =
  Atdgen_runtime.Ov_run.validate_list validate_web_response
;;
...
let validate__web_response_option =
  Atdgen_runtime.Ov_run.validate_option validate_web_response
;;
...
let validate_thread_flow_location : _ -> thread_flow_location -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_thread_flow_location x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
    ...
    (match validate__location_option (`Field "location" :: path) x.location with
     ...
     | None ->
       (match
        ...
        | Some _ as err -> err
        | None ->
          (match validate__stack_option (`Field "stack" :: path) x.stack with
           | Some _ as err -> err
           | None ->
             (match validate__hm_str_mms_option (`Field "state" :: path) x.state with
              | Some _ as err -> err
              | None ->
                (match
                 ...
                 | None ->
                   (match
                      validate__web_request_option
                        (`Field "web_request" :: path)
                        x.web_request
                    with
                    | Some _ as err -> err
                    | None ->
                      validate__web_response_option
                        (`Field "web_response" :: path)
                        x.web_response))))))
;;

let validate__thread_flow_location_list =
  Atdgen_runtime.Ov_run.validate_list validate_thread_flow_location
;;

let validate__thread_flow_location_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__thread_flow_location_list
;;

let validate_thread_flow : _ -> thread_flow -> _ =
  fun path x ->
  match
    validate__hm_str_mms_option (`Field "immutable_state" :: path) x.immutable_state
  with
  | Some _ as err -> err
  | None ->
    (match
       validate__hm_str_mms_option (`Field "initial_state" :: path) x.initial_state
     with
     | Some _ as err -> err
     | None ->
       (match
          validate__thread_flow_location_list (`Field "locations" :: path) x.locations
        with
        | Some _ as err -> err
        | None ->
          (match validate__message_option (`Field "message" :: path) x.message with
...
let validate__thread_flow_list = Atdgen_runtime.Ov_run.validate_list validate_thread_flow
...
let validate_code_flow : _ -> code_flow -> _ =
  ...
  | None ->
    (match validate__property_bag_option (`Field "properties" :: path) x.properties with
     | Some _ as err -> err
     | None -> validate__thread_flow_list (`Field "thread_flows" :: path) x.thread_flows)
;;

let validate__code_flow_list = Atdgen_runtime.Ov_run.validate_list validate_code_flow

let validate__code_flow_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__code_flow_list
;;

let rec validate__node_list path x =
  (Atdgen_runtime.Ov_run.validate_list validate_node) path x

and validate__node_list_option path x =
  (Atdgen_runtime.Ov_run.validate_option validate__node_list) path x
...
and validate_node : _ -> node -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_node x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__node_list_option (`Field "children" :: path) x.children with
     | Some _ as err -> err
     | None ->
       (match validate__message_option (`Field "label" :: path) x.label with
        | Some _ as err -> err
...
let rec validate__exception_list path x =
  (Atdgen_runtime.Ov_run.validate_list validate_exception_) path x

and validate__exception_list_option path x =
  (Atdgen_runtime.Ov_run.validate_option validate__exception_list) path x

and validate_exception_ : _ -> exception_ -> _ =
  fun path x ->
  match
    validate__exception_list_option (`Field "inner_exceptions" :: path) x.inner_exceptions
  with
  | Some _ as err -> err
  | None ->
    (match validate__property_bag_option (`Field "properties" :: path) x.properties with
     | Some _ as err -> err
     | None -> validate__stack_option (`Field "stack" :: path) x.stack)
;;
...
let validate_graph : _ -> graph -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_graph x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match validate__message_option (`Field "description" :: path) x.description with
     | Some _ as err -> err
     | None ->
       (match validate__edge_list_option (`Field "edges" :: path) x.edges with
        | Some _ as err -> err
        | None ->
          (match validate__node_list_option (`Field "nodes" :: path) x.nodes with
           | Some _ as err -> err
           | None ->
             validate__property_bag_option (`Field "properties" :: path) x.properties)))
;;

let validate__graph_list = Atdgen_runtime.Ov_run.validate_list validate_graph

let validate__graph_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__graph_list
;;
...
let validate_result : _ -> result -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_result x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__artifact_location_option
         (`Field "analysis_target" :: path)
         x.analysis_target
     with
     | Some _ as err -> err
     | None ->
       (match
          validate__attachment_list_option (`Field "attachments" :: path) x.attachments
        with
        | Some _ as err -> err
        | None ->
          (match
             validate__code_flow_list_option (`Field "code_flows" :: path) x.code_flows
           with
           | Some _ as err -> err
           | None ->
             (match
                validate__result_correlation_guid_option
                  (`Field "correlation_guid" :: path)
                  x.correlation_guid
              with
              | Some _ as err -> err
              | None ->
                (match validate__fix_list_option (`Field "fixes" :: path) x.fixes with
                 | Some _ as err -> err
                 | None ->
                   (match
                      validate__graph_traversal_list_option
                        (`Field "graph_traversals" :: path)
                        x.graph_traversals
                    with
                    | Some _ as err -> err
                    | None ->
                      (match
                         validate__graph_list_option (`Field "graphs" :: path) x.graphs
                       with
                       | Some _ as err -> err
                       | None ->
                         (match
                            validate__result_guid_option (`Field "guid" :: path) x.guid
                          with
                          | Some _ as err -> err
                          | None ->
                            (match
                             ...
                             | None ->
                               (match
                                  validate_message (`Field "message" :: path) x.message
                                with
                                | Some _ as err -> err
                                | None ->
                                  (match
...
let validate__exception_option = Atdgen_runtime.Ov_run.validate_option validate_exception_
...
let validate_notification : _ -> notification -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_notification x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
    ...
    (match
     ...
     | None ->
       (match
        ...
        | None ->
          (match
             validate__exception_option (`Field "exception_" :: path) x.exception_
           with
           | Some _ as err -> err
           | None ->
             (match
                validate__location_list_option (`Field "locations" :: path) x.locations
              with
              | Some _ as err -> err
              | None ->
                (match validate_message (`Field "message" :: path) x.message with
                 | Some _ as err -> err
                 | None ->
                   validate__property_bag_option
                     (`Field "properties" :: path)
...
let validate__notification_list =
  Atdgen_runtime.Ov_run.validate_list validate_notification
;;

let validate__notification_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__notification_list
;;
...
let validate_invocation : _ -> invocation -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_invocation x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__artifact_location_option
         (`Field "executable_location" :: path)
         x.executable_location
     with
     | Some _ as err -> err
     | None ->
       (match
          validate__configuration_override_list_option
            (`Field "notification_configuration_overrides" :: path)
            x.notification_configuration_overrides
        with
        | Some _ as err -> err
        | None ->
          (match
           ...
           | None ->
             (match
              ...
              | None ->
                (match
                   validate__configuration_override_list_option
                     (`Field "rule_configuration_overrides" :: path)
                     x.rule_configuration_overrides
                 with
                 | Some _ as err -> err
                 | None ->
                   (match
                             ...
                             | None ->
                               (match
                                  validate__notification_list_option
                                    (`Field "tool_configuration_notifications" :: path)
                                    x.tool_configuration_notifications
                                with
                                | Some _ as err -> err
                                | None ->
                                  (match
                                     validate__notification_list_option
                                       (`Field "tool_execution_notifications" :: path)
                                       x.tool_execution_notifications
                                   with
                                   | Some _ as err -> err
                                   | None ->
                                     validate__artifact_location_option
                                       (`Field "working_directory" :: path)
                                       x.working_directory)))))))))))
;;

let validate__invocation_option =
  Atdgen_runtime.Ov_run.validate_option validate_invocation
;;
...
let validate_conversion : _ -> conversion -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_conversion x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__artifact_location_list_option
         (`Field "analysis_tool_log_files" :: path)
         x.analysis_tool_log_files
     with
     | Some _ as err -> err
     | None ->
       (match validate__invocation_option (`Field "invocation" :: path) x.invocation with
        | Some _ as err -> err
        | None ->
          (match
             validate__property_bag_option (`Field "properties" :: path) x.properties
           with
           | Some _ as err -> err
           | None -> validate_tool (`Field "tool" :: path) x.tool)))
;;

let validate__result_option = Atdgen_runtime.Ov_run.validate_option validate_result

let validate__conversion_option =
  Atdgen_runtime.Ov_run.validate_option validate_conversion
;;

let rec validate__artifact_list path x =
  (Atdgen_runtime.Ov_run.validate_list validate_artifact) path x

and validate__artifact_list_option path x =
  (Atdgen_runtime.Ov_run.validate_option validate__artifact_list) path x

and validate__external_properties_option path x =
  (Atdgen_runtime.Ov_run.validate_option validate_external_properties) path x
...
and validate_artifact : _ -> artifact -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_artifact x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__artifact_content_option (`Field "contents" :: path) x.contents with
     | Some _ as err -> err
     | None ->
       (match validate__message_option (`Field "description" :: path) x.description with
        | Some _ as err -> err
        | None ->
          (match
             validate__artifact_location_option (`Field "location" :: path) x.location
           with
           | Some _ as err -> err
           | None ->
             (match
                validate__artifact_mimetype_option
                  (`Field "mime_type" :: path)
                  x.mime_type
              with
              | Some _ as err -> err
              | None ->
...
and validate_external_properties : _ -> external_properties -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_external_properties x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__address_list_option (`Field "addresses" :: path) x.addresses with
     | Some _ as err -> err
     | None ->
       (match validate__artifact_list_option (`Field "artifacts" :: path) x.artifacts with
        | Some _ as err -> err
        | None ->
          (match
             validate__conversion_option (`Field "conversion" :: path) x.conversion
           with
           | Some _ as err -> err
           | None ->
             (match
                validate__tool_component_option (`Field "driver" :: path) x.driver
              with
              | Some _ as err -> err
              | None ->
                (match
                   validate__tool_component_list_option
                     (`Field "extensions" :: path)
                     x.extensions
                 with
                 | Some _ as err -> err
                 | None ->
                   (match
                      validate__property_bag_option
                        (`Field "externalized_properties" :: path)
                        x.externalized_properties
                    with
                    | Some _ as err -> err
                    | None ->
                      (match
                         validate__graph_list_option (`Field "graph" :: path) x.graph
                       with
                       | Some _ as err -> err
                       | None ->
                         (match
                                               ...
                                               | None ->
                                                 (match
                                                    validate__thread_flow_location_list_option
                                                      (`Field "thread_flow_locations"
                                                       :: path)
                                                      x.thread_flow_locations
                                                  with
                                                  | Some _ as err -> err
                                                  | None ->
                                                    (match
                                                       validate__tool_component_list_option
                                                         (`Field "translations" :: path)
                                                         x.translations
                                                     with
                                                     | Some _ as err -> err
                                                     | None ->
...
let validate_version_control_details : _ -> version_control_details -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_version_control_details x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__artifact_location_option (`Field "mapped_to" :: path) x.mapped_to
     with
     | Some _ as err -> err
     | None -> validate__property_bag_option (`Field "properties" :: path) x.properties)
;;
...
let validate_special_locations : _ -> special_locations -> _ =
  fun path x ->
  match
    validate__artifact_location_option (`Field "display_base" :: path) x.display_base
  with
  | Some _ as err -> err
  | None -> validate__property_bag_option (`Field "properties" :: path) x.properties
;;

let validate_sarif_version _ _ = None

let validate_run_language path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_run_language" in
  if Sarif_v_2_1_0_util.validate_run_language x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate_run_column_kind _ _ = None

let validate_run_baseline_guid path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_run_baseline_guid" in
  if Sarif_v_2_1_0_util.validate_run_baseline_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate_run_automation_details_guid path x =
  let msg = "Failed check by Sarif_v_2_1_0_util.validate_run_automation_details_guid" in
  if Sarif_v_2_1_0_util.validate_run_automation_details_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate_run_automation_details_correlation_guid path x =
  let msg =
    "Failed check by Sarif_v_2_1_0_util.validate_run_automation_details_correlation_guid"
  in
  if Sarif_v_2_1_0_util.validate_run_automation_details_correlation_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;
...
let validate__option_46715fb =
  Atdgen_runtime.Ov_run.validate_option validate_run_automation_details_correlation_guid
;;
...
let validate_run_automation_details : _ -> run_automation_details -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_run_automation_details x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__option_46715fb (`Field "correlation_guid" :: path) x.correlation_guid
     with
     | Some _ as err -> err
     | None ->
       (match validate__message_option (`Field "description" :: path) x.description with
        ...
        | None ->
          (match
             validate__run_automation_details_guid_option (`Field "guid" :: path) x.guid
           with
           | Some _ as err -> err
           | None ->
             validate__property_bag_option (`Field "properties" :: path) x.properties)))
...
let validate__x_9eb6bac =
  Atdgen_runtime.Ov_run.validate_list (fun path x ->
    let _, x = x in
    validate_artifact_location (`Index 1 :: path) x)
;;

let validate_hm_str_al = validate__x_9eb6bac

let validate_external_property_file_reference_guid path x =
  let msg =
    "Failed check by Sarif_v_2_1_0_util.validate_external_property_file_reference_guid"
  in
  if Sarif_v_2_1_0_util.validate_external_property_file_reference_guid x
  then None
  else Some (Atdgen_runtime.Util.Validation.error ~msg path)
;;

let validate__option_9c938c9 =
  Atdgen_runtime.Ov_run.validate_option validate_external_property_file_reference_guid
;;
...
let validate_external_property_file_reference : _ -> external_property_file_reference -> _
  ...
  match
    (fun path x ->
      let msg =
        "Failed check by Sarif_v_2_1_0_util.validate_external_property_file_reference"
      in
      if Sarif_v_2_1_0_util.validate_external_property_file_reference x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__option_9c938c9 (`Field "guid" :: path) x.guid with
     | Some _ as err -> err
     | None ->
       (match
          validate__artifact_location_option (`Field "location" :: path) x.location
...
let validate__external_property_file_reference_option =
  Atdgen_runtime.Ov_run.validate_option validate_external_property_file_reference
;;

let validate_external_property_file_references
  : _ -> external_property_file_references -> _
  =
  fun path x ->
  match
    (fun path x ->
      let msg =
        "Failed check by Sarif_v_2_1_0_util.validate_external_property_file_references"
      in
      if Sarif_v_2_1_0_util.validate_external_property_file_references x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | Some _ as err -> err
  | None ->
    (match validate__option_927609b (`Field "addresses" :: path) x.addresses with
     | Some _ as err -> err
     | None ->
       (match validate__option_927609b (`Field "artifacts" :: path) x.artifacts with
        | Some _ as err -> err
        | None ->
          (match
           ...
           | None ->
             (match
              ...
              | None ->
                (match
                   validate__option_927609b (`Field "extensions" :: path) x.extensions
                 with
                 | Some _ as err -> err
                 | None ->
                   (match
                    ...
                    | None ->
                      (match
                         validate__option_927609b (`Field "graphs" :: path) x.graphs
                       with
                       | Some _ as err -> err
                       | None ->
                         (match
                                      ...
                                      | None ->
                                        (match
                                         ...
                                         | None ->
                                           (match
                                              validate__option_927609b
                                                (`Field "thread_flow_locations" :: path)
                                                x.thread_flow_locations
                                            with
                                            | Some _ as err -> err
                                            | None ->
                                              (match
                                               ...
                                               | None ->
                                                 (match
                                                  ...
                                                  | None ->
                                                    validate__option_927609b
                                                      (`Field "web_responses" :: path)
                                                      x.web_responses))))))))))))))))
;;

let validate__version_control_details_list =
  Atdgen_runtime.Ov_run.validate_list validate_version_control_details
;;

let validate__version_control_details_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__version_control_details_list
;;

let validate__special_locations_option =
  Atdgen_runtime.Ov_run.validate_option validate_special_locations
;;

let validate__run_language_option =
  Atdgen_runtime.Ov_run.validate_option validate_run_language
;;

let validate__run_column_kind_option _ _ = None

let validate__run_baseline_guid_option =
  Atdgen_runtime.Ov_run.validate_option validate_run_baseline_guid
;;

let validate__run_automation_details_option =
  Atdgen_runtime.Ov_run.validate_option validate_run_automation_details
;;

let validate__run_automation_details_list =
  Atdgen_runtime.Ov_run.validate_list validate_run_automation_details
;;

let validate__run_automation_details_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__run_automation_details_list
;;

let validate__result_list = Atdgen_runtime.Ov_run.validate_list validate_result

let validate__result_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__result_list
;;

let validate__invocation_list = Atdgen_runtime.Ov_run.validate_list validate_invocation

let validate__invocation_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__invocation_list
;;

let validate__hm_str_al_option = Atdgen_runtime.Ov_run.validate_option validate_hm_str_al

let validate__external_property_file_references_option =
  Atdgen_runtime.Ov_run.validate_option validate_external_property_file_references
;;
...
let validate_run : _ -> run -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_run x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
        ...
        | None ->
          (match
             validate__run_automation_details_option
               (`Field "automation_details" :: path)
               x.automation_details
           with
           | Some _ as err -> err
           | None ->
             (match
                validate__run_baseline_guid_option
                  (`Field "baseline_guid" :: path)
                  x.baseline_guid
              with
              | Some _ as err -> err
              | None ->
                 ...
                 | None ->
                   (match
                      validate__external_property_file_references_option
                        (`Field "external_property_file_references" :: path)
                        x.external_property_file_references
                    with
                    | Some _ as err -> err
                    | None ->
                      (match
                                ...
                                | None ->
                                  (match
                                     validate__hm_str_al_option
                                       (`Field "original_uri_base_ids" :: path)
                                       x.original_uri_base_ids
                                   with
                                   | Some _ as err -> err
                                   | None ->
                                     (match
...
let validate__run_list = Atdgen_runtime.Ov_run.validate_list validate_run

let validate__external_properties_list =
  Atdgen_runtime.Ov_run.validate_list validate_external_properties
;;

let validate__external_properties_list_option =
  Atdgen_runtime.Ov_run.validate_option validate__external_properties_list
;;
...
let validate_sarif_json_schema : _ -> sarif_json_schema -> _ =
  ...
  match
    (fun path x ->
      ...
      if Sarif_v_2_1_0_util.validate_sarif_json_schema x
      then None
      else Some (Atdgen_runtime.Util.Validation.error ~msg path))
      path
      x
  ...
  | None ->
    (match
       validate__external_properties_list_option
         (`Field "inline_external_properties" :: path)
         x.inline_external_properties
     with
     | Some _ as err -> err
     | None ->
       (match
        ...
        with
        | Some _ as err -> err
        | None -> validate__run_list (`Field "runs" :: path) x.runs))
;;
...
let create_logical_location
  ...
  : logical_location
  =
  { decorated_name; fully_qualified_name; index; kind; name; parent_index; properties }
;;

let create_message ?arguments ?id ?markdown ?properties ?text () : message =
  { arguments; id; markdown; properties; text }
;;

let create_artifact_location ?description ?(index = -1L) ?properties ?uri ?uri_base_id ()
  : artifact_location
  =
  { description; index; properties; uri; uri_base_id }
;;

let create_edge ~id ?label ?properties ~source_node_id ~target_node_id () : edge =
  { id; label; properties; source_node_id; target_node_id }
;;

let create_location_relationship ?description ?kinds ?properties ~target ()
  : location_relationship
  =
  { description; kinds; properties; target }
;;

let create_multiformat_message_string ?markdown ?properties ~text ()
  : multiformat_message_string
  =
  { markdown; properties; text }
;;

let create_artifact_content ?binary ?properties ?rendered ?text () : artifact_content =
  { binary; properties; rendered; text }
;;
...
let create_edge_traversal
  ...
  : edge_traversal
  =
  { edge_id; final_state; message; properties; step_over_edge_count }
;;
...
let create_rectangle ?bottom ?left ?message ?properties ?right ?top () : rectangle =
  { bottom; left; message; properties; right; top }
;;
...
let create_attachment ~artifact_location ?description ?properties ?rectangles ?regions ()
  : attachment
  =
  { artifact_location; description; properties; rectangles; regions }
;;
...
let create_physical_location
  ...
  : physical_location
  =
  { address; artifact_location; context_region; properties; region }
;;
...
let create_replacement ~deleted_region ?inserted_content ?properties () : replacement =
  { deleted_region; inserted_content; properties }
;;

let create_artifact_change ~artifact_location ?properties ~replacements ()
  : artifact_change
  =
  { artifact_location; properties; replacements }
;;

let create_fix ~artifact_changes ?description ?properties () : fix =
  { artifact_changes; description; properties }
;;
...
let create_reporting_configuration
  ...
  =
  { enabled; level; parameters; properties; rank }
;;
...
let create_stack_frame ?location ?module_ ?parameters ?properties ?thread_id ()
  : stack_frame
  =
  { location; module_; parameters; properties; thread_id }
;;

let create_stack ~frames ?message ?properties () : stack = { frames; message; properties }

let create_suppression ?guid ?justification ~kind ?location ?properties ?status ()
  : suppression
  =
  { guid; justification; kind; location; properties; status }
;;

let create_tool_component_reference ?guid ?(index = -1L) ?name ?properties ()
  : tool_component_reference
  =
  { guid; index; name; properties }
;;
...
let create_reporting_descriptor_reference
  ...
  =
  { guid; id; index; properties; tool_component }
;;

let create_configuration_override ~configuration ~descriptor ?properties ()
  : configuration_override
  =
  { configuration; descriptor; properties }
;;

let create_reporting_descriptor_relationship ?description ?kinds ?properties ~target ()
...
let create_tool ~driver ?extensions ?properties () : tool =
  { driver; extensions; properties }
;;
...
let create_web_request
  ...
  : web_request
  =
  { body; headers; index; method_; parameters; properties; protocol; target; version }
;;
...
let create_thread_flow
  ...
  : thread_flow
  =
  { id; immutable_state; initial_state; locations; message; properties }
;;

let create_code_flow ?message ?properties ~thread_flows () : code_flow =
  { message; properties; thread_flows }
;;

let create_node ?children ~id ?label ?location ?properties () : node =
  { children; id; label; location; properties }
;;

let create_exception_ ?inner_exceptions ?kind ?message ?properties ?stack () : exception_ =
  { inner_exceptions; kind; message; properties; stack }
;;

let create_graph ?description ?edges ?nodes ?properties () : graph =
  { description; edges; nodes; properties }
;;
...
let create_conversion ?analysis_tool_log_files ?invocation ?properties ~tool ()
  : conversion
  =
  { analysis_tool_log_files; invocation; properties; tool }
;;
...
let create_special_locations ?display_base ?properties () : special_locations =
  { display_base; properties }
;;

let create_run_automation_details ?correlation_guid ?description ?guid ?id ?properties ()
  : run_automation_details
  =
  { correlation_guid; description; guid; id; properties }
;;
...
let create_external_property_file_reference
  ...
  =
  { guid; item_count; location; properties }
;;
...
let create_sarif_json_schema
  ...
  : sarif_json_schema
  =
  { version; inline_external_properties; properties; runs; schema }
;;
